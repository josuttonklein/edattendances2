...
#### 5. Count how many attendances occur by by locality.

```{r}
attend <- wholedata %>% count (lsoa11)

```

#### 5b. Count how many attendances occur by agegroup, sex and locality.
...
attendage <- attendage %>% mutate(highmiss = case_when(misfract >= 0.15 ~ 1, misfract  < 0.15 ~ 0))
```
